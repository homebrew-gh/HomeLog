      ...
      <main className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-white dark:bg-slate-800 border-sky-200 dark:border-slate-700">
            ...
            <CardContent className="space-y-4 text-sm text-slate-600 dark:text-slate-400">
              <p>
                Cypher Log uses NIP-44 encryption to protect your sensitive data:
              </p>
              <ul className="list-disc list-inside space-y-2 ml-2">
          ...
          <Card className="bg-white dark:bg-slate-800 border-sky-200 dark:border-slate-700">
            ...
            <CardContent className="space-y-4 text-sm text-slate-600 dark:text-slate-400">
              ...
              <ul className="list-disc list-inside space-y-2 ml-2">
                <li><strong>Cypher Log never has access to your private key:</strong> Authentication is handled by your Nostr signer (browser extension, Amber, etc.)</li>
          ...
          <Card className="bg-white dark:bg-slate-800 border-sky-200 dark:border-slate-700">
            ...
            <CardContent className="space-y-4 text-sm text-slate-600 dark:text-slate-400">
              <p>
                Cypher Log interacts with the following third parties:
              </p>
